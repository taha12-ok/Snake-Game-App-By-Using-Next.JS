...
export default function SnakeGame() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-[#21214e] to-[#47207e]">
  <div className="bg-[#2E2E48] rounded-lg shadow-lg p-8 w-full max-w-md">
    <div className="flex items-center justify-between mb-6">
      <div className="text-3xl font-bold text-[#00FFFF]">Snake Game</div>
      <div className="flex gap-4">
        <Button
          variant="ghost"
          size="icon"
          className="text-[#00FFFF] hover:text-[#1E90FF] focus:ring-2 focus:ring-[#00FFFF] hover:shadow-[0_0_10px_#00FFFF]"
          onClick={startGame}
        >
        ...
        return (
          <div
            ...
            className={`w-5 h-5 rounded-sm ${
              isSnakePart
                ? "bg-[#39FF14]" // Neon Green for snake
                : isFood
                ? "bg-[#FF007F]" // Neon Pink for food
                : "bg-[#2E2E48]"  // Darker background for empty tiles
            }`}
          />
        );
      })}
